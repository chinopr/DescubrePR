            ...
            <main className="px-4 md:px-10 py-6 md:py-8 flex flex-1 justify-center">
                <div className="max-w-[1200px] w-full flex flex-col gap-8">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            <h1 className="text-3xl md:text-4xl font-black mb-2 text-slate-900 dark:text-white">Clasificados PR</h1>
                            <p className="text-slate-500 dark:text-slate-400">Encuentra servicios, productos y alquileres locales.</p>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        <div className="w-full md:w-64 shrink-0 flex flex-col gap-6">
                            <div className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                                <h3 className="font-bold text-lg mb-4 text-slate-900 dark:text-white">Filtrar por Tipo</h3>
                                    ...
                                    {services.map(service => (
                                        ...
                                        >
                                            ...
                                            <div className="p-4 flex flex-col flex-1">
                                                <h3 className="font-bold text-lg mb-2 text-slate-900 dark:text-white group-hover:text-primary transition-colors line-clamp-1">{service.titulo}</h3>
