...
export default function PlaceDetail({ id }: { id: string }) {
    ...
    return (
        <div className="flex min-h-screen w-full flex-col bg-background-light dark:bg-background-dark pb-16 md:pb-0">
            <EngagementViewTracker targetType="place" targetId={place.id} />
            <Header />
            ...
            <main className="flex-1 w-full max-w-[1200px] mx-auto bg-white dark:bg-slate-900 md:my-8 md:rounded-2xl md:shadow-sm overflow-hidden border-x border-y-0 md:border-y border-slate-200 dark:border-slate-800">
                ...
                <div className="relative w-full h-[40vh] md:h-[50vh] bg-slate-200 dark:bg-slate-800">
                    ...
                    <div className="absolute top-4 right-4 flex gap-2">
                        ...
                        <ShareButtons title={place.nombre} text={place.descripcion || `Descubre ${place.nombre} en ${place.municipio}`} hashtags={['PuertoRico', 'Lugares']} />
                    </div>
                    <div className="absolute bottom-0 left-0 w-full p-6 text-white">
                        ...
                        <h1 className="text-4xl md:text-5xl font-black text-white mb-2">{place.nombre}</h1>
                ...
                <div className="flex flex-col lg:flex-row gap-8 p-6 md:p-8">
                    <div className="flex-1 flex flex-col gap-8">
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Sobre este lugar</h2>
                        ...
                        {place.categorias.length > 0 && (
                            <section>
                                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Categorías</h3>
                        ...
                        {place.fotos.length > 1 && (
                            <section>
                                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Galería</h3>
                    ...
                    <div className="w-full lg:w-80 shrink-0 flex flex-col gap-6">
                        ...
                        {(place.lat !== null && place.lng !== null) || directionsHref ? (
                            <>
                                ...
                                {directionsHref ? (
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        onClick={() => trackEngagement({ action: 'click', targetType: 'place', targetId: place.id })}
