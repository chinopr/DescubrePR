                ...
                <div className="max-w-[1000px] w-full flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-4">
                        {loading ? (
                            ...
                            events.map(event => (
                                <div key={event.id} className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 flex flex-col sm:flex-row gap-4 hover:shadow-md transition-shadow group cursor-pointer">
                                    <div
                                    ...
                                    <div className="flex flex-col justify-center flex-1">
                                        <h3 className="text-xl font-bold group-hover:text-primary transition-colors line-clamp-2 md:line-clamp-1 mb-2">
                                            {event.titulo}
                                        </h3>
